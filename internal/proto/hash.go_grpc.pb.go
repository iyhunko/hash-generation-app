...
type HashServiceClient interface {
	GetHash(ctx context.Context, in *Hash, opts ...grpc.CallOption) (*Hash, error)
}
...
func (c *hashServiceClient) GetHash(ctx context.Context, in *Hash, opts ...grpc.CallOption) (*Hash, error) {
	out := new(Hash)
	err := c.cc.Invoke(ctx, "/hash.HashService/GetHash", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HashServiceServer interface {
	GetHash(context.Context, *Hash) (*Hash, error)
...
func (UnimplementedHashServiceServer) GetHash(context.Context, *Hash) (*Hash, error) {
...
func _HashService_GetHash_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hash.HashService/GetHash",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HashServiceServer).GetHash(ctx, req.(*Hash))
	}
